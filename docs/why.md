...
`go-ruby-format/format` reimplements Ruby's format-string engine in **pure Go, with cgo disabled**. The
...
- any Go program can import `github.com/go-ruby-format/format` directly, with no Ruby runtime;
