...
Contributions are welcome. `go-ruby-format/format` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-format/format`](https://github.com/go-ruby-format/format). This documentation site is in
[`github.com/go-ruby-format/docs`](https://github.com/go-ruby-format/docs). Start from the
